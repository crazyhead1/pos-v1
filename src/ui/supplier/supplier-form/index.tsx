        ...
        <div className={classes.container}>
          <div className="form-group">
            <div className={classes.row}>
              ...
              <div className={classes.column}>
                <label htmlFor="name">
                  Company Name<span className={classes.colorRed}>*</span>
                </label>
                <input
                  type="text"
                  className="form-control"
          ...
          <div className="form-group">
            ...
            <div className={classes.row}>
              ...
              <div className={classes.column}>
                <label htmlFor="mainContactCompanyPosition">
                  Company Position
                </label>
                <input
                  type="number"
          ...
          <hr />
          <div className="form-group">
            <label htmlFor="additionalInfromation">
              Additional Infromation
            </label>
            <input
              type="text"
              className="form-control"
              id="additionalInfromation"
              name="additionalInfromation"
              value={formik.values.additionalInfromation}
              onChange={formik.handleChange}
            />
          </div>
          <div className="form-group">
            ...
            <input
              ...
              id="additionalFile"
              name="additionalFile"
              value={formik.values.additionalFile}
              onChange={formik.handleChange}
            />
          </div>
          <div className="form-group">
